...
def extract_features(data):
    ...
    # Fill null data with median of age
...
#      alg.fit(features.iloc[train, :],
#              data['Survived'].iloc[train])
...
#   accuracy = 1 - error_nb / data.shape[0]
    ...
    # Also, we can use the method of sklearn instead of a butch of code above
